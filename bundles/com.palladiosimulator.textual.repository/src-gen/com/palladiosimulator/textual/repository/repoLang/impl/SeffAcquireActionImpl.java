...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Seff Acquire Action</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.palladiosimulator.textual.repository.repoLang.impl.SeffAcquireActionImpl#getResource <em>Resource</em>}</li>
 *   <li>{@link com.palladiosimulator.textual.repository.repoLang.impl.SeffAcquireActionImpl#getAmount <em>Amount</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SeffAcquireActionImpl extends SeffActionImpl implements SeffAcquireAction
{
   ...
   * @generated
   */
  protected SeffAcquireActionImpl()
  {
    super();
  }
    ...
    if (resource != null && resource.eIsProxy())
    {
      ...
      if (resource != oldResource)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RepoLangPackage.SEFF_ACQUIRE_ACTION__RESOURCE, oldResource, resource));
      }
    }
    return resource;
  }
  ...
  public void setResource(PassiveResource newResource)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepoLangPackage.SEFF_ACQUIRE_ACTION__RESOURCE, oldResource, resource));
  }
  ...
  public void setAmount(int newAmount)
  {
    ...
    amount = newAmount;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepoLangPackage.SEFF_ACQUIRE_ACTION__AMOUNT, oldAmount, amount));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RepoLangPackage.SEFF_ACQUIRE_ACTION__RESOURCE:
        if (resolve) return getResource();
        return basicGetResource();
      case RepoLangPackage.SEFF_ACQUIRE_ACTION__AMOUNT:
        return getAmount();
    }
