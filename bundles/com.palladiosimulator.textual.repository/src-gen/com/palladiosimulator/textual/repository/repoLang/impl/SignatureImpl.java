 ...
 * </p>
 * <ul>
 *   <li>{@link com.palladiosimulator.textual.repository.repoLang.impl.SignatureImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.palladiosimulator.textual.repository.repoLang.impl.SignatureImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SignatureImpl extends MinimalEObjectImpl.Container implements Signature
{
  ...
  {
    return RepoLangPackage.Literals.SIGNATURE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RepoLangPackage.SIGNATURE__NAME, oldName, name));
  }
  ...
  public EList<SignatureParameter> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<SignatureParameter>(SignatureParameter.class, this, RepoLangPackage.SIGNATURE__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RepoLangPackage.SIGNATURE__PARAMETERS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RepoLangPackage.SIGNATURE__NAME:
        return getName();
      case RepoLangPackage.SIGNATURE__PARAMETERS:
